...
function registerHandlers(reviewBot: Chat) {
...
export function getReviewBot() {
  if (!reviewBotSingleton) {
    reviewBotSingleton = createReviewBot();
    registerHandlers(reviewBotSingleton);
  }

  return reviewBotSingleton;
}
